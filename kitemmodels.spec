...
Version  : 5.110.0
Release  : 71
URL      : https://download.kde.org/stable/frameworks/5.110/kitemmodels-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kitemmodels-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kitemmodels-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kitemmodels-5.110.0
cd %{_builddir}/kitemmodels-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694446755
mkdir -p clr-build
pushd clr-build
