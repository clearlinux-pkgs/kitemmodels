...
Source0  : https://download.kde.org/stable/frameworks/5.113/kitemmodels-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/kitemmodels-5.113.0.tar.xz.sig
...
%prep
%setup -q -n kitemmodels-5.113.0
cd %{_builddir}/kitemmodels-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702965442
mkdir -p clr-build
pushd clr-build
