...
Version  : 5.103.0
Release  : 63
URL      : https://download.kde.org/stable/frameworks/5.103/kitemmodels-5.103.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.103/kitemmodels-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/kitemmodels-5.103.0.tar.xz.sig
...
%prep
%setup -q -n kitemmodels-5.103.0
cd %{_builddir}/kitemmodels-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676847044
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ItemModels.so.5.103.0
