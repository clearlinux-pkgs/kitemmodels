...
Source0  : https://download.kde.org/stable/frameworks/5.105/kitemmodels-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/kitemmodels-5.105.0.tar.xz.sig
...
%prep
%setup -q -n kitemmodels-5.105.0
cd %{_builddir}/kitemmodels-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681138510
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ItemModels.so.5.105.0
