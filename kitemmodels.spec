...
Source0  : https://download.kde.org/stable/frameworks/6.3/kitemmodels-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kitemmodels-6.3.0.tar.xz.sig
...
%setup -q -n kitemmodels-6.3.0
cd %{_builddir}/kitemmodels-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717780163
mkdir -p clr-build
pushd clr-build
