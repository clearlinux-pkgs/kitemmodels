...
Version  : 6.2.0
Release  : 82
URL      : https://download.kde.org/stable/frameworks/6.2/kitemmodels-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/kitemmodels-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kitemmodels-6.2.0.tar.xz.sig
...
%setup -q -n kitemmodels-6.2.0
cd %{_builddir}/kitemmodels-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715620775
mkdir -p clr-build
pushd clr-build
