...
Version  : 5.108.0
Release  : 69
URL      : https://download.kde.org/stable/frameworks/5.108/kitemmodels-5.108.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.108/kitemmodels-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/kitemmodels-5.108.0.tar.xz.sig
...
%prep
%setup -q -n kitemmodels-5.108.0
cd %{_builddir}/kitemmodels-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688856936
mkdir -p clr-build
pushd clr-build
